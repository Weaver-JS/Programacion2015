...
#define GAME_SPEED 0.009f
#define GAME_TEXTURES 24
...
#define NPC_WIDTH 32
#define NPC_HEIGHT 64



#define layerNum 2
#define LAYERLENGTH 20
//Hearts
...
#define INVENTORY_X_POSITION WIDTH -320
#define INVENTORY_Y_POSITION HEIGHT-32
#define INVENTORY_WIDTH 32
#define INVENTORY_HEIGHT 32

#define ENEMY_WIDTH 31
#define ENEMY_HEIGHT 60
 
#define MainCharacter_WIDTH 36
#define MainCharacter_HEIGHT 64

#define BULLET_SPRITE 24

#define WIN_SPRITE 25
#define LOSE_SPRITE 26


//Game has four possible states: INIT (Preparing environment), PLAY (Playing), EXIT (Exit from the game) or MENU (Game menu)
enum class GameState{ INIT, PLAY, EXIT, MENU,WIN,LOSE };
