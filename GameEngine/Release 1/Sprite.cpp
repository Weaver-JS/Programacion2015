...
* Default constructor
*/
Sprite::Sprite() :_xAtWorld(0), _yAtWorld(0), _textureID(-1), _currentFrame(0), _maxFrames(1),_spriteWidth(SPRITE_DEFAULT_WIDTH),_spriteHeight(SPRITE_DEFAULT_HEIGHT) { }
...
*/
void Sprite::setInitialValues(int newXPosition, int newYPosition, int textureId, int spriteWidth, int spriteHeight, int currentFrame, int maxFrames) {
